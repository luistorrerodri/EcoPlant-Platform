...
**Por qué Gemini y no Claude**: coste cero para el uso a demanda que le da Luis (unas pocas fotos por semana), frente a los céntimos al mes que costaría con la API de pago de Claude — nada que justifique el gasto para este caso de uso concreto. Contrapartida asumida conscientemente: en el nivel gratuito de Gemini, Google puede usar el contenido enviado para mejorar sus productos (en el de pago, explícitamente no) — aceptable para una foto de una planta, no para datos sensibles. Si el proyecto llegara a necesitar ese nivel de garantía, el cambio es solo la clave y la llamada en `plant_vision.py`, no un rediseño.
